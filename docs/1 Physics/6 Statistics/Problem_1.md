...
- This project aims to simulate and visualize the behavior of charged particles under the influence of electric and magnetic fields $$ \vec{E}, \vec{B} $$
- We apply the Lorentz force law:
...
- **Circular or helical motion** in uniform magnetic fields $$ \vec{B} $$
- **Drift motion** in crossed electric and magnetic fields $$ \vec{E} \ \& \ \vec{B} $$
...
- Identify real-world systems using Lorentz force:
  ...
  - Plasma confinement devices (tokamaks)
  - Mass spectrometers
- Discuss how electric and magnetic fields $$ \vec{E}, \vec{B} $$ influence motion
...
- Compute and visualize trajectories under:
  ...
  - Crossed electric and magnetic fields $$ \vec{E} \ \& \ \vec{B} $$
...
- Highlight Larmor radius and E × B drift $$ \vec{E} \times \vec{B} $$
...
<body>
  ...
  <script>
    ...
    // Simulation 3: Pure Electric Field
