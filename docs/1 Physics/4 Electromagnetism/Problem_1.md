...
\[ \eta_{\text{sum}}(x, y, t) = \sum_{i=1}^{N} \eta_i(x, y, t) \]</pre>
  ...
  <section>
    ...
    <p>This extended model uses complex numbers to represent waves, ideal for analyzing phase interactions.</p>
    <pre>
\[ \eta_i(x, y, t) = \frac{A}{\sqrt{r_i}} e^{j(kr_i - \omega t + \phi_i)} \]
\[ \eta_{total}(x, y, t) = \Re\left\{ \sum_{i=1}^{N} \eta_i(x, y, t) \right\} \]</pre>
    <canvas id="canvas2" width="600" height="600"></canvas>
  </section>

  <script>
    // JavaScript remains the same as current merged version.
  </script>
</body>
</html>
